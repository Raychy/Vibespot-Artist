...
import 'package:vsartist/views/artist_features/music/music-bloc.dart';
import 'package:vsartist/views/artist_features/music/music-functions.dart';
...
class MusicHome extends StatefulWidget implements AppRoute {
  @override
  String get routeNam => routeName;

  static String get routeName => 'music-home';
                  ...
                  delegate: _SliverAppBarDelegate(
                    ...
                    child: NotificationListener<ScrollNotification>(
                      ...
                      child: PageView(
                        ...
                        physics:
                            new NeverScrollableScrollPhysics(), // I completely disabled left and right swiping
                ...
                SliverToBoxAdapter(
                  child: SizedBox(
                    ...
                    child: NotificationListener<ScrollNotification>(
                      ...
                      child: PageView(
                        physics:
                            new NeverScrollableScrollPhysics(), // to disable left and right swiping
