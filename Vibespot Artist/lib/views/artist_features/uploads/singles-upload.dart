...
class SinglesUpload extends StatefulWidget implements AppRoute {
  @override
  String get routeNam => routeName;

  static String get routeName => 'singles-upload';
  ...
  SinglesUpload({this.pages, this.pager, this.releaseName, this.uploadSingles});
  @override
...
class _SinglesUploadState extends State<SinglesUpload>
  ...
  _submit() async {
    if (formKey.currentState!.validate()) {
      ...
      uploadSingles!.tracks![widget.pager!] = musicUpload;
      if (widget.pager! + 1 < widget.pages!) {
        uploadCommon.singleUploadPage(context, widget.pages, widget.pager! + 1,
                        ...
                        new Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              submitButton(widget.pager! + 1, widget.pages),
                            ],
                          ),
                        ),
                      ],
  ...
  Widget build(BuildContext context) {
    return ScaffoldCommon(
      ...
      appTitle: '#${widget.pager! + 1}/${widget.pages} - ${widget.releaseName}',
      bodyData: body(),
      showDrawer: false,
    );
  }
