...
//   String _filePath;
//   List<String> single_Ids;
//   // album_id ----- integer
//   //  ----- array of integer
//   //  String _time;
//   // List<MusicModel> musicsModel = List();
//   List<dynamic> musicsModel = List();
//   ////////////////
//   String value = "";
...
//
//   void getSongs() async {
//     List<dynamic> allSongs = await network.getAllMusics(context: context);
//     setState(() {
...
//
//   _submit() async {
//     single_Ids = sendtoServer;
//     print(sendtoServer);
//     if (single_Ids == [] && single_Ids == null) {
//       print("Id is empty");
//     } else {
//       print(single_Ids);
//     }
...
//                                 children: [
//                                   formsWidget
//                                       .sectionHeader('Select Existing Songs'),
