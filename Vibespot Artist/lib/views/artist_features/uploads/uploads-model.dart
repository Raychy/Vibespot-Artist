...
class UploadAlbum {
  ...
  Map<String, dynamic> toJson(UploadAlbum instance) => <String, dynamic>{
        ...
        // 'tracks': instance.tracks != null ? instance.tracks.toList() : "",
      };
...
class Music {
  ...
  Map<String, dynamic> toJson(Music instance) {
    ...
    return {
      ...
      'featureBy': instance.featureBy,
      'producedBy': instance.producedBy,
      // 'single_ids': instance.single_Ids
    };
  }
  ...
  factory Music.fromJson(Map<String, dynamic> json) {
    return new Music(
      ...
      featureBy: json['featureBy'],
      producedBy: json['producedBy'],
    );
  }
}
...
class MusicModel {
  ...
  MusicModel.fromJson(Map<String, dynamic> json) {
    ...
    genre = json['genre'];
    duration = json['duration'];
    streamed = json['streamed'];
    paidCount = json['paidCount'];
    state = json['state'];
    pushState = json['push_state'];
    pushCity = json['push_city'];
    image = json['image'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['id'] = this.id;
    data['release_id'] = this.releaseId;
    ...
    data['streamed'] = this.streamed;
    data['paidCount'] = this.paidCount;
    data['state'] = this.state;
    data['push_state'] = this.pushState;
    data['push_city'] = this.pushCity;
...
class AlbumCoverProcessModelInstance {
  int selectedIndex = -1;
  UploadAlbum? selectedAlbum = null;
}
