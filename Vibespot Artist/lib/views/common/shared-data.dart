...
class SharedData {
  ...
  final String _countryToken = "countryToken";
  final String _isUserLogin = "isUserLogin";
  final String _isRecordLabel = "isRecordLabel ";
  ...
  Future<bool> getIsRecordLabel() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.getBool(_isRecordLabel) ?? false;
  }

  Future<bool> setIsRecordLabel(bool value) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.setBool(_isRecordLabel, value);
  }
...
//  }
  ...
  Future<String?> getCountryToken() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.getString(_countryToken);
  }
  ...
  Future<bool> setCountryToken(String value) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();

    return prefs.setString(_countryToken, value);
  }
  ...
  Future<String> getAuthUserData() async {
    ...
    return prefs.getString(_authUserData)?? '';
  }
